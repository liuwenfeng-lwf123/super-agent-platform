...
import TokenBudgetTab from "@/components/settings/TokenBudgetTab";
...
export default function SettingsPanel({ onBack }: Props) {
  const [tab, setTab] = useState<"models" | "memory" | "skills" | "mcp" | "knowledge" | "demo" | "security" | "tracing" | "features" | "token_budget">("features");
  ...
  const tabs = [
    ...
    { key: "token_budget" as const, label: "Token 预算", icon: Activity },
  ];
    ...
    <div className="h-full flex flex-col" style={{ background: "var(--bg-primary)" }}>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-thin">
          ...
          {/* Token Budget */}
          {tab === "token_budget" && <TokenBudgetTab />}
